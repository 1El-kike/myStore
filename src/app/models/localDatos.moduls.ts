...
export const StoreList:Store[]= [
    {
      ...
      start:'4,5',
      product:[
        {id:1,name:"Aceite",loading:false,img:"https://media.istockphoto.com/id/493652014/es/foto/botella-de-aceite-de-oliva.jpg?s=612x612&w=0&k=20&c=sP8GuGOD-o3_fPyirvPJeN3MTffFsZmIl7_H06EnzzY=",description:'blabla',price:'34,56',added:false,comprado:false},
        {id:2,name:"Detergente",loading:false,img:"https://plazavea.vteximg.com.br/arquivos/ids/14673251-512-512/20112023.jpg",description:'blablab  lbalvablabllblbalb alblbalalblba llablalbassdasdsa dsdsfdsfs dfsdfeferifj',price:'34,56',added:false,comprado:false},
        {id:3,name:"Caldito de Pollo",loading:false,img:"/tienda5tay96.jpg",description:'blabla',price:'34,56',added:false,comprado:false},
        {id:4,name:"Perritos",loading:false,img:"/tools",description:'blabla',price:'34,56',added:false,comprado:false},
        {id:5,name:"Arroz",loading:false,img:"https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg",description:'blabla',price:'34,56',added:false,comprado:false},
        {id:6,name:"Arroz",loading:false,img:"https://img.envioscuba.com/Img_Data/500x500/b0d5ed4d-efb6-431e-a1dc-0dc4b81c8bc4.jpg",description:'blabla',price:'34,56',added:false,comprado:false},
