import { Component, OnChanges , Input, SimpleChanges,CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
import { AllElement } from '../../../models/localDatos.moduls';
...
export class SearchElementComponent implements OnChanges {
   ...
   @Input() searchProduct:AllElement[]   = [];
   @Input() input?:string;
    valor: AllElement[] = [];
    status = ''
